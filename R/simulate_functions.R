...
#' @param number_clocks unique tau to be present in the simulation
#' @param purity sample purity
#' @param coverage average number of reads that align to a reference base
#' @param epsilon minimum distance between taus in terms of pseudo time
#' @param seed simulation seed
#' @param vector_karyo possible karyotypes to be included in the inference
#' @param time_interval time interval
#' @param mu  mutation rate
#' @param w cell division rate
#' @param l length of the segments
#' 
#' @return list of simulated data and x object on which to perform the inference
#' @export
